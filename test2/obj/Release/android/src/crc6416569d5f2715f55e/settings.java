...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ESehiyye.settings, test2", settings.class, __md_methods);
	}
	...
	public settings ()
	{
		...
		if (getClass () == settings.class)
			mono.android.TypeManager.Activate ("ESehiyye.settings, test2", "", this, new java.lang.Object[] {  });
	}
